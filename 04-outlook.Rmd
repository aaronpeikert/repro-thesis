...
I have argued there that the metascientific advantage is to validate the induction process and a practical advantage is to increase productivity.
...
Superficially it relies on R, RStudio, Pandoc, Git, Make, Docker, and for OS X on Homebrew and for Windows on Chocolaty as software and on GitHub, DockerHub, MRAN and Ubuntu Package Archive as services.
...
This problem is widely recognized and because of the limited requirements---a typical project needs around one gigabyte of storage---there are several solutions available [@doornIntroductionArchivingResearch2007].
