...
To that end, it stands on the shoulders of giants and provides only a minimal layer of abstraction for the aforementioned tools.
...
I also provide a minimal example actually contains data and a data analysis in the [Creation] section below.
