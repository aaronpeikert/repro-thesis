...
This assumptions hold for most open-source software and is straight forward to implement for all software available in the Ubuntu Package Archive.
...
A prime example of this is the ethical and legal considerations of publishing data that can only with great difficulty be de-identified.
