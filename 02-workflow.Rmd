...
2. Every path must be relative to that folder.
...
Providing a direct link, dynamic document generation allows interspersing text with code and its results, producing a wide range of output formats[^markdown].
