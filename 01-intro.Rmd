...
Some have even argued that this democratisation of Science is what fueled the scientific revolution [@heilbronOxfordCompanionHistory2004, Scientific Revolution].
...
More massive amounts of more complicated computer code than ever create room for errors and misunderstandings, leading the machine learning community to believe that they face a reproducibility crisis [@hutsonArtificialIntelligenceFaces2018].
...
@peikertReproducibleDataAnalysis2019 put forth an analysis workflow which provides just this accessibility for everyone to reproduce any analysis.
